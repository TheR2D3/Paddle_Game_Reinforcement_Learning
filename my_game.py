...
class my_game():
    def __init__(self):       
        ...
        self.paddle = pygame.Rect(350, 495, 100, 10)
        self.ball = pygame.Rect(10, 250, 15, 15)                
        self.ball_direction = (5, 5)
        self.balls = 3       
        self.episode = 0 
    ...
    def run_frame(self):
        ...
        self.episode_string = "Episode: " + str(self.episode)
        self.miss_string = "Miss: " + str(self.miss)        
        self.text_hit = self.font.render(self.hit_string, True, (0, 128, 0))
        self.text_episode =  self.font.render(self.episode_string, True, (0, 128, 0))
        ...
        self.screen.blit(self.text_episode,(300, 20))
